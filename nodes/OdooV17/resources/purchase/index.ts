...
export const purchaseDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"value": "Get Purchase Order",
					"action": "Get Purchase Order by ID",
					"description": "Read a single purchase.order record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
				...
				},
				{
					...
					"value": "Delete Purchase Order",
					"action": "Delete Purchase Order",
					"description": "Delete a purchase.order record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/purchase.order/{{$parameter[\"id\"]}}"
				...
				},
				{
					...
					"value": "Get Purchase Order Line",
					"action": "Get Purchase Order Line by ID",
					"description": "Read a single purchase.order.line record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
				...
				},
				{
					...
					"value": "Delete Purchase Order Line",
					"action": "Delete Purchase Order Line",
					"description": "Delete a purchase.order.line record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/purchase.order.line/{{$parameter[\"id\"]}}"
		...
		{
			"displayName": "GET /api/purchase.order/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/purchase.order/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/purchase.order.line/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/purchase.order.line/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
