...
export const saleDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"description": "Create a new sale.order record. Uses Odoo `create` method.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/sale.order"
				...
				{
					"name": "Get Sale Order",
					"value": "Get Sale Order",
					"action": "Get Sales Order by ID",
					"description": "Read a single sale.order record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/api/sale.order/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Update Sale Order",
					"value": "Update Sale Order",
					"action": "Update Sales Order",
					"description": "Update an existing sale.order record. Uses Odoo `write` method.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/sale.order/{{$parameter[\"id\"]}}"
				...
				},
				{
					...
					"value": "Delete Sale Order",
					"action": "Delete Sales Order",
					"description": "Delete a sale.order record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/sale.order/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Call Sale Order",
					"value": "Call Sale Order",
					"action": "Call method on Sales Order",
					"description": "Call any method on a sale.order record. Uses Odoo `execute_kw` with method name.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/sale.order/{{$parameter[\"id\"]}}/call"
						}
					}
				},
				{
				...
				{
					"name": "Create Sale Order Line",
					"value": "Create Sale Order Line",
					"action": "Create Sales Order Line",
					"description": "Create a new sale.order.line record. Uses Odoo `create` method.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/sale.order.line"
				...
				{
					"name": "Get Sale Order Line",
					"value": "Get Sale Order Line",
					"action": "Get Sales Order Line by ID",
					"description": "Read a single sale.order.line record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/api/sale.order.line/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Update Sale Order Line",
					"value": "Update Sale Order Line",
					"action": "Update Sales Order Line",
					"description": "Update an existing sale.order.line record. Uses Odoo `write` method.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/sale.order.line/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Delete Sale Order Line",
					"value": "Delete Sale Order Line",
					"action": "Delete Sales Order Line",
					"description": "Delete a sale.order.line record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/sale.order.line/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Call Sale Order Line",
					"value": "Call Sale Order Line",
					"action": "Call method on Sales Order Line",
					"description": "Call any method on a sale.order.line record. Uses Odoo `execute_kw` with method name.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/sale.order.line/{{$parameter[\"id\"]}}/call"
						}
					}
				}
			],
		...
		{
			"displayName": "POST /api/sale.order",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/sale.order/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /api/sale.order/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/sale.order/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/sale.order/{id}/call",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/sale.order.line",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/sale.order.line/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /api/sale.order.line/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/sale.order.line/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/sale.order.line/{id}/call",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
