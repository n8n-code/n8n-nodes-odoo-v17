...
export const mailDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"value": "Get Mail Message",
					"action": "Get Message by ID",
					"description": "Read a single mail.message record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
				...
				},
				{
					...
					"value": "Delete Mail Message",
					"action": "Delete Message",
					"description": "Delete a mail.message record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/mail.message/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Get Mail Thread",
					"value": "Get Mail Thread",
					"action": "Get Email Thread by ID",
					"description": "Read a single mail.thread record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
				...
				},
				{
					...
					"value": "Delete Mail Thread",
					"action": "Delete Email Thread",
					"description": "Delete a mail.thread record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/mail.thread/{{$parameter[\"id\"]}}"
		...
		{
			"displayName": "GET /api/mail.message/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/mail.message/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/mail.thread/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/mail.thread/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
