...
export const projectDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"description": "Read a single project.project record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
				...
				},
				{
					...
					"value": "Delete Project Project",
					"action": "Delete Project",
					"description": "Delete a project.project record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/project.project/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Call Project Project",
					"value": "Call Project Project",
					"action": "Call method on Project",
					"description": "Call any method on a project.project record. Uses Odoo `execute_kw` with method name.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/project.project/{{$parameter[\"id\"]}}/call"
						}
					}
				},
				{
				...
				},
				{
					...
					"value": "Get Project Task",
					"action": "Get Task by ID",
					"description": "Read a single project.task record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
				...
				},
				{
					...
					"value": "Delete Project Task",
					"action": "Delete Task",
					"description": "Delete a project.task record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/project.task/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Call Project Task",
					"value": "Call Project Task",
					"action": "Call method on Task",
					"description": "Call any method on a project.task record. Uses Odoo `execute_kw` with method name.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/project.task/{{$parameter[\"id\"]}}/call"
						}
					}
				}
			],
		...
		{
			"displayName": "GET /api/project.project/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/project.project/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/project.project/{id}/call",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/project.task/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/project.task/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/project.task/{id}/call",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
