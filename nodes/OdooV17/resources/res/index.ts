...
export const resDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"value": "Create Res Partner",
					"action": "Create Contact",
					"description": "Create a new res.partner record. Uses Odoo `create` method.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/res.partner"
				...
				{
					"name": "Get Res Partner",
					"value": "Get Res Partner",
					"action": "Get Contact by ID",
					"description": "Read a single res.partner record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/api/res.partner/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Update Res Partner",
					"value": "Update Res Partner",
					"action": "Update Contact",
					"description": "Update an existing res.partner record. Uses Odoo `write` method.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/res.partner/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Delete Res Partner",
					"value": "Delete Res Partner",
					"action": "Delete Contact",
					"description": "Delete a res.partner record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/res.partner/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Call Res Partner",
					"value": "Call Res Partner",
					"action": "Call method on Contact",
					"description": "Call any method on a res.partner record. Uses Odoo `execute_kw` with method name.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/res.partner/{{$parameter[\"id\"]}}/call"
						}
					}
				},
				{
				...
				{
					"name": "Create Res Partner Bank",
					"value": "Create Res Partner Bank",
					"action": "Create Bank Accounts",
					"description": "Create a new res.partner.bank record. Uses Odoo `create` method.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/res.partner.bank"
				...
				{
					"name": "Get Res Partner Bank",
					"value": "Get Res Partner Bank",
					"action": "Get Bank Accounts by ID",
					"description": "Read a single res.partner.bank record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/api/res.partner.bank/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Update Res Partner Bank",
					"value": "Update Res Partner Bank",
					"action": "Update Bank Accounts",
					"description": "Update an existing res.partner.bank record. Uses Odoo `write` method.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/res.partner.bank/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Delete Res Partner Bank",
					"value": "Delete Res Partner Bank",
					"action": "Delete Bank Accounts",
					"description": "Delete a res.partner.bank record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/res.partner.bank/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Call Res Partner Bank",
					"value": "Call Res Partner Bank",
					"action": "Call method on Bank Accounts",
					"description": "Call any method on a res.partner.bank record. Uses Odoo `execute_kw` with method name.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/res.partner.bank/{{$parameter[\"id\"]}}/call"
						}
					}
				},
				{
				...
				{
					"name": "Create Res Partner Category",
					"value": "Create Res Partner Category",
					"action": "Create Partner Tags",
					"description": "Create a new res.partner.category record. Uses Odoo `create` method.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/res.partner.category"
				...
				{
					"name": "Get Res Partner Category",
					"value": "Get Res Partner Category",
					"action": "Get Partner Tags by ID",
					"description": "Read a single res.partner.category record by ID. Uses Odoo `read` method.",
					"routing": {
						"request": {
							"method": "GET",
							"url": "=/api/res.partner.category/{{$parameter[\"id\"]}}"
						}
					}
				},
				{
					"name": "Update Res Partner Category",
					"value": "Update Res Partner Category",
					"action": "Update Partner Tags",
					"description": "Update an existing res.partner.category record. Uses Odoo `write` method.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/res.partner.category/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Delete Res Partner Category",
					"value": "Delete Res Partner Category",
					"action": "Delete Partner Tags",
					"description": "Delete a res.partner.category record. Uses Odoo `unlink` method.",
					"routing": {
						"request": {
							"method": "DELETE",
							"url": "=/api/res.partner.category/{{$parameter[\"id\"]}}"
				...
				{
					"name": "Call Res Partner Category",
					"value": "Call Res Partner Category",
					"action": "Call method on Partner Tags",
					"description": "Call any method on a res.partner.category record. Uses Odoo `execute_kw` with method name.",
					"routing": {
						"request": {
							"method": "POST",
							"url": "=/api/res.partner.category/{{$parameter[\"id\"]}}/call"
						}
					}
				}
			],
		...
		{
			"displayName": "POST /api/res.partner",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/res.partner/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /api/res.partner/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/res.partner/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/res.partner/{id}/call",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/res.partner.bank",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/res.partner.bank/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /api/res.partner.bank/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/res.partner.bank/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/res.partner.bank/{id}/call",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/res.partner.category",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "GET /api/res.partner.category/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "PUT /api/res.partner.category/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "DELETE /api/res.partner.category/{id}",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
		...
		{
			"displayName": "POST /api/res.partner.category/{id}/call",
			"name": "operation",
			"type": "notice",
			"typeOptions": {
				"theme": "info"
