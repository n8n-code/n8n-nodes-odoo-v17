...
export const posDescription: INodeProperties[] = [
		...
		},
		{
			...
			"default": "name,module_pos_restaurant,id",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
		...
		},
		{
			...
			"name": "fields",
			"description": "Comma-separated field names to return",
			"default": "name,state,partner_id,amount_total,id",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
		...
		},
		{
			...
			"name": "fields",
			"description": "Comma-separated field names to return",
			"default": "name,order_id,product_id,qty,price_unit,id",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
		...
		},
		{
			...
			"name": "fields",
			"description": "Comma-separated field names to return",
			"default": "name,state,config_id,id",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
