...
export const crmDescription: INodeProperties[] = [
			...
			"options": [
				...
				},
				{
					...
					"value": "Upsert Crm Lead",
					"action": "Upsert Lead",
					"description": "Create or update crm.lead record.\n\nSearch by name (Opportunity Name) from `_key`. If found → update with data fields, if not → create new record.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/crm.lead"
				...
				{
					"name": "Upsert Crm Stage",
					"value": "Upsert Crm Stage",
					"action": "Upsert Stage",
					"description": "Create or update crm.stage record.\n\nSearch by name (Stage Name) from `_key`. If found → update with data fields, if not → create new record.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/crm.stage"
				...
				{
					"name": "Upsert Crm Tag",
					"value": "Upsert Crm Tag",
					"action": "Upsert Tag",
					"description": "Create or update crm.tag record.\n\nSearch by name (Tag Name) from `_key`. If found → update with data fields, if not → create new record.",
					"routing": {
						"request": {
							"method": "PUT",
							"url": "=/api/crm.tag"
		...
		},
		{
			...
			"default": "name,partner_id,stage_id,id",
			"type": "string",
			"routing": {
				"send": {
					"type": "query",
